...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2023 a las 01:33:29
...
(21, 50, 4, 'Razer', 'DEATHSTALKER V2', 'negro', 'Presentamos nuestra primera gama de teclados ópticos ultrafinos optimizados para ofrecer un rendimiento y una durabilidad excelentes. Experimenta un juego ultrasensible gracias a su uso ergonómico de larga duración con switches de perfil bajo to', 'sin especificar', 'sin especificar', 'sin especificar'),
(22, 50, 6, 'Marshall', 'willen', 'negro', 'Los parlantes son equipos de audio que reproducen y maximizan la calidad del sonido del artefacto al cual se encuentre conectado.', 'sin especificar', 'sin especificar', 'sin especificar');
...
(48, 'Torres', 'Mejia', 'Leslie', '1995-12-25', 'F', '935704056', 'ltorres@isise.edu', '2023-04-04 22:40:13'),
(49, 'Cieza', 'Marrufo', 'Xamir', '1996-02-02', 'M', '935704777', 'cieza@gmail.com', '2023-04-05 13:22:24'),
(50, 'Tapia', 'Arcos', 'Sara', '1997-03-05', 'F', '935704256', 'sara@gmail.com', '2023-04-05 14:04:16');
...
(16, 95, 4, 50, 'El teclado del ctrl izquierdo no funciona.', 'se cambio la tecla por otra.', 0, '2023-04-05 19:36:59');
...
(93, 1, 48, 'ltorres', '$2y$10$o43Rmk2scs6Fl/XZmbXSDuhzD55YZNoEC5GYVfLDl6UeUdX3IiXZq', 'modulo cliente', 0, '0000-00-00 00:00:00'),
(95, 1, 50, 'stapia', '$2y$10$59U9GE8nyMgKFxA4aYa/v.iUTRPAMrwiJErZ.KaoqRNFGZEnFkRqS', 'modulo cliente', 1, '2023-04-05 19:32:29');
...
--
ALTER TABLE `t_asignacion`
  MODIFY `id_asignacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
